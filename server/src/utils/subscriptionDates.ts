...
export function getCurrentMonthWindow(date: Date) {
  return {
...
export function getNextBillingWindow(date: Date) {
...
export function getDaysRemaining(now: Date, endDate: Date): number {
