...
export async function getOrganizerProfilePayload(userId) {
...
export const updateOrganizerProfile = asyncHandler(async (req, res) => {
    ...
    await query(`update organizers set payment_phone=$1 where user_id=$2 returning payment_phone`, [paymentPhone, req.user.id]);
